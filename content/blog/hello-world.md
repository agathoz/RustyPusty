...
title = "Hello World"
date = 2025-12-11
description = "First post on the new RustyPusty site."
[taxonomies]
tags = ["general", "update"]
+++

Hello world! This is the first post on the relatable **People** this is a test to see if the site is working.
